...
John Herrman, a tech columnist at New York Magazine's Intelligencer, spent time this week setting up an OpenClaw agent and wrote about it with the skeptical curiosity of someone watching a genuinely important technology from just outside the hype bubble. The resulting piece — [published April 28th](https://nymag.com/intelligencer/article/my-adventures-setting-up-openclaw-agent.html) — is worth reading if you want to understand how OpenClaw is landing with intelligent non-technical observers.
...
The full article is live at [nymag.com/intelligencer](https://nymag.com/intelligencer/article/my-adventures-setting-up-openclaw-agent.html).
